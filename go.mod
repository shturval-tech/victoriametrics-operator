module github.com/shturval-tech/victoriametrics-operator

go 1.20

require (
	github.com/VictoriaMetrics/VictoriaMetrics v1.94.0
	...
	github.com/shturval-tech/victoriametrics-operator/api v0.0.0-20240217125053-6e04b47cc8a2
...
replace (
	github.com/shturval-tech/victoriametrics-operator/api => ./api
