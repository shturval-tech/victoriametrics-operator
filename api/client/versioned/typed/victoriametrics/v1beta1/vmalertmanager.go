...
func newVMAlertmanagers(c *VictoriametricsV1beta1Client, namespace string) *vMAlertmanagers {
...
func (c *vMAlertmanagers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VMAlertmanager, err error) {
	result = &v1beta1.VMAlertmanager{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vmalertmanagers").
		Name(name).
...
func (c *vMAlertmanagers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VMAlertmanagerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.VMAlertmanagerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vmalertmanagers").
...
func (c *vMAlertmanagers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vMAlertmanagers) Create(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.CreateOptions) (result *v1beta1.VMAlertmanager, err error) {
	result = &v1beta1.VMAlertmanager{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vmalertmanagers").
...
func (c *vMAlertmanagers) Update(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.UpdateOptions) (result *v1beta1.VMAlertmanager, err error) {
	result = &v1beta1.VMAlertmanager{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vmalertmanagers").
		Name(vMAlertmanager.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vMAlertmanager).
		Do(ctx).
		Into(result)
...
func (c *vMAlertmanagers) UpdateStatus(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.UpdateOptions) (result *v1beta1.VMAlertmanager, err error) {
	result = &v1beta1.VMAlertmanager{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vmalertmanagers").
...
func (c *vMAlertmanagers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vMAlertmanagers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vMAlertmanagers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VMAlertmanager, err error) {
	result = &v1beta1.VMAlertmanager{}
