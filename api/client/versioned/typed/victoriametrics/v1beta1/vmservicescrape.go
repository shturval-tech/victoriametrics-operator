...
// VMServiceScrapesGetter has a method to return a VMServiceScrapeInterface.
...
// vMServiceScrapes implements VMServiceScrapeInterface
type vMServiceScrapes struct {
	client rest.Interface
	ns     string
}

// newVMServiceScrapes returns a VMServiceScrapes
func newVMServiceScrapes(c *VictoriametricsV1beta1Client, namespace string) *vMServiceScrapes {
...
func (c *vMServiceScrapes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VMServiceScrape, err error) {
	result = &v1beta1.VMServiceScrape{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vMServiceScrapes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VMServiceScrapeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.VMServiceScrapeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vmservicescrapes").
...
func (c *vMServiceScrapes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vMServiceScrapes) Create(ctx context.Context, vMServiceScrape *v1beta1.VMServiceScrape, opts v1.CreateOptions) (result *v1beta1.VMServiceScrape, err error) {
	result = &v1beta1.VMServiceScrape{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vmservicescrapes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vMServiceScrape).
		Do(ctx).
		Into(result)
	return
}
...
func (c *vMServiceScrapes) Update(ctx context.Context, vMServiceScrape *v1beta1.VMServiceScrape, opts v1.UpdateOptions) (result *v1beta1.VMServiceScrape, err error) {
	result = &v1beta1.VMServiceScrape{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vmservicescrapes").
		Name(vMServiceScrape.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vMServiceScrape).
		Do(ctx).
		Into(result)
...
func (c *vMServiceScrapes) UpdateStatus(ctx context.Context, vMServiceScrape *v1beta1.VMServiceScrape, opts v1.UpdateOptions) (result *v1beta1.VMServiceScrape, err error) {
	result = &v1beta1.VMServiceScrape{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vmservicescrapes").
...
func (c *vMServiceScrapes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vMServiceScrapes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vMServiceScrapes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VMServiceScrape, err error) {
	result = &v1beta1.VMServiceScrape{}
