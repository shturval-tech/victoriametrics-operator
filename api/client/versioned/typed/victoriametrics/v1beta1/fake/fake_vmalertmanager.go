...
var vmalertmanagersResource = schema.GroupVersionResource{Group: "victoriametrics", Version: "v1beta1", Resource: "vmalertmanagers"}

var vmalertmanagersKind = schema.GroupVersionKind{Group: "victoriametrics", Version: "v1beta1", Kind: "VMAlertmanager"}
...
func (c *FakeVMAlertmanagers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VMAlertmanager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(vmalertmanagersResource, c.ns, name), &v1beta1.VMAlertmanager{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.VMAlertmanager), err
}

// List takes label and field selectors, and returns the list of VMAlertmanagers that match those selectors.
func (c *FakeVMAlertmanagers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VMAlertmanagerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(vmalertmanagersResource, vmalertmanagersKind, c.ns, opts), &v1beta1.VMAlertmanagerList{})
	...
	list := &v1beta1.VMAlertmanagerList{ListMeta: obj.(*v1beta1.VMAlertmanagerList).ListMeta}
	for _, item := range obj.(*v1beta1.VMAlertmanagerList).Items {
...
func (c *FakeVMAlertmanagers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(vmalertmanagersResource, c.ns, opts))
...
func (c *FakeVMAlertmanagers) Create(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.CreateOptions) (result *v1beta1.VMAlertmanager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(vmalertmanagersResource, c.ns, vMAlertmanager), &v1beta1.VMAlertmanager{})
...
func (c *FakeVMAlertmanagers) Update(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.UpdateOptions) (result *v1beta1.VMAlertmanager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(vmalertmanagersResource, c.ns, vMAlertmanager), &v1beta1.VMAlertmanager{})
...
func (c *FakeVMAlertmanagers) UpdateStatus(ctx context.Context, vMAlertmanager *v1beta1.VMAlertmanager, opts v1.UpdateOptions) (*v1beta1.VMAlertmanager, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(vmalertmanagersResource, "status", c.ns, vMAlertmanager), &v1beta1.VMAlertmanager{})
...
func (c *FakeVMAlertmanagers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(vmalertmanagersResource, c.ns, name, opts), &v1beta1.VMAlertmanager{})
...
func (c *FakeVMAlertmanagers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(vmalertmanagersResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.VMAlertmanagerList{})
	return err
}
...
func (c *FakeVMAlertmanagers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VMAlertmanager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(vmalertmanagersResource, c.ns, name, pt, data, subresources...), &v1beta1.VMAlertmanager{})
