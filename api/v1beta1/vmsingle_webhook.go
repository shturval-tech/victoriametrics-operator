...
func (r *VMSingle) ValidateCreate() (warnings admission.Warnings, err error) {
...
func (r *VMSingle) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
	if r.Spec.ParsingError != "" {
		return nil, fmt.Errorf(r.Spec.ParsingError)
	}
	if mustSkipValidation(r) {
...
func (r *VMSingle) ValidateDelete() (warnings admission.Warnings, err error) {
	// no-op
	return nil, nil
}
