...
func (r *VMAlertmanager) ValidateCreate() (warnings admission.Warnings, err error) {
...
func (r *VMAlertmanager) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
	if r.Spec.ParsingError != "" {
		return nil, fmt.Errorf(r.Spec.ParsingError)
	}
	if mustSkipValidation(r) {
...
func (r *VMAlertmanager) ValidateDelete() (warnings admission.Warnings, err error) {
	// no-op
	return nil, nil
}
