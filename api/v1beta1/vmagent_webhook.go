...
func (r *VMAgent) ValidateCreate() (warnings admission.Warnings, err error) {
...
func (r *VMAgent) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
	if r.Spec.ParsingError != "" {
		return nil, fmt.Errorf(r.Spec.ParsingError)
	}
	if mustSkipValidation(r) {
...
func (cr *VMAgent) ValidateDelete() (warnings admission.Warnings, err error) {
	// no-op
	return nil, nil
}
