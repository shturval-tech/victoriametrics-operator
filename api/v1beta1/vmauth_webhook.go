...
func (r *VMAuth) ValidateCreate() (warnings admission.Warnings, err error) {
...
func (r *VMAuth) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
	if r.Spec.ParsingError != "" {
		return nil, fmt.Errorf(r.Spec.ParsingError)
	}
	if mustSkipValidation(r) {
...
func (r *VMAuth) ValidateDelete() (warnings admission.Warnings, err error) {
	return nil, nil
}
