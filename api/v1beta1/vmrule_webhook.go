...
func (r *VMRule) ValidateCreate() (warnings admission.Warnings, err error) {
	vmrulelog.Info("validate create", "name", r.Name)
	// skip validation, if object has annotation.
	if mustSkipValidation(r) {
		return nil, nil
	}
	return nil, r.sanityCheck()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (r *VMRule) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
...
func (r *VMRule) ValidateDelete() (warnings admission.Warnings, err error) {
	// noop
	return nil, nil
}
