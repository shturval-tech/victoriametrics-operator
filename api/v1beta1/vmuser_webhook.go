...
func (cr *VMUser) ValidateCreate() (warnings admission.Warnings, err error) {
...
func (cr *VMUser) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
	if mustSkipValidation(cr) {
		return nil, nil
	}
	if err := cr.sanityCheck(); err != nil {
...
func (r *VMUser) ValidateDelete() (warnings admission.Warnings, err error) {
	return nil, nil
}
